...
/* new Promise((resolve, reject) => {
  ...
  .then(value => console.log('1-1 成功', value))
  .then(value => console.log('1-2 成功', value))
  .then(value => console.log('1-3 成功', value))
  .catch(err => {
...
new Promise((resolve, reject) => {
  ...
  .then(value => console.log('2-1 成功', value))
  .then(value => console.log('2-2 成功', value))
  .catch(err => {
